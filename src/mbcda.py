...
parser.add_argument("-b", "--num_beams", default=2, type=int, help="number of beams for beam search")
...
parser.add_argument("-l", "--max_length", default=200, type=int, help="maximum sentence length")
...
if __name__ == '__main__':
    ...
    # with open('outputs/parallel_label_wiki_error_logit_0.txt') as file:
    ...
    if mode == "train":
        ...
        label_j = []
        gen_text = []
        filename1 = "outputs/parallel_labels.txt"
        try:
            os.remove(filename1)
        except:
            filename1
        filename2 = "outputs/show_errors.txt"
        try:
            os.remove(filename2)
        except:
            filename2
        with open(filename1, "a") as f:
            for ii, labels_batch in enumerate(label_chunks):
                ...
                inter_labels, cleaned_labels = clean_text.generate(labels_batch, max_length, num_beams)
