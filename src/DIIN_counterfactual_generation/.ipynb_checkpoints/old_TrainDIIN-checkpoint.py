...
class TrainDIIN:
    ...
    def train_model(attribute_list1, attribute_list2, n_factors, in_channel, n_flow, hidden_depth, hidden_dim, rho, batch_size, chunk_size):    
        ...
        import os
        attribute_pair = "catholic_muslim"
        ...
        for iteration in range(chunk_size, chunk_size+1, chunk_size+1):
            ...
            torch.save(bertflow, model_path+'/bertflow_rho_0999_factors_'+'6'+'.pth')
