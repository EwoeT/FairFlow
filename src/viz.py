...
corpus_tokenizer = GenderAttributeTokenizer.corpus_tokenizer(model_name, attribute_list1 = attribute_list1, attribute_list2 = attribute_list2, seq_len=seq_len)
train_dataset_1, val_dataset_1 = corpus_tokenizer.get_corpus_token_ids(attribute_df)

# torch.save(train_dataset_1, "1_train_dataset.pt")
# torch.save(val_dataset_1, "1_val_dataset.pt")

# train_dataset_1 = torch.load("1_train_dataset.pt")
# val_dataset_1 = torch.load("1_val_dataset.pt")
get_attribute_tokens = GenderAttributeTokenizer.get_attribute_tokens(model_name, attribute_list1, attribute_list2, train_dataset_1, val_dataset_1)
get_attribute_tokens.generate_tokens()


# train gender classifier
train_attrbitue_classifier = GenderAttributeClassifier.AttributeClassifer(model_name, attribute_list1, attribute_list2)
